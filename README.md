...
If you only require primer design without the need for primer set combination, you may use the primer design module of MultiPrime, which is accessible through multiPrime-core.py or pip install multiPrime (version >=2.3.8) and utilize the DPrime function.
