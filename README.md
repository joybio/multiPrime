...
Once you set up your configuration file, running the pipeline locally on your computer is as easy as invoking:
  ...
  ```bash
  snakemake --configfile multiPrime.yaml -s multiPrime.py --cores 10 --resources 80000
  ```
  ...
  ```bash
  snakemake --configfile multiPrime2.yaml -s multiPrime2.py --cores 10 --resources 80000
  ```
